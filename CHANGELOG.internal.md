...
### Fixed
- F1 validation now follows changed workflow behavior, avoiding unrelated test drives on documentation and infrastructure PRs. Nonfunctional releases can supply reviewed payload-bound verification while functional releases retain relevant F1 coverage. ([CYPACK-1537](https://linear.app/ceedar/issue/CYPACK-1537), [#1503](https://github.com/cyrusagents/cyrus/pull/1503))
