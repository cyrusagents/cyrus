...
### Changed
- Prepared and validated a local multi-user test candidate with the complete CLI package graph and installed-artifact F1 checks; documented the missing supported feature publishing route without changing main-only release safeguards. ([CYPACK-1502](https://linear.app/ceedar/issue/CYPACK-1502), [#1472](https://github.com/cyrusagents/cyrus/pull/1472))
