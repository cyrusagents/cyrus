...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.263` to [`0.3.266`](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#03266), preserving shell working-directory changes across turns, expanding user-message correlation for synthetic and self-started turns, and bringing Claude sessions to parity with Claude Code 2.1.266. `@anthropic-ai/sdk` remains current at [`^0.124.0`](https://github.com/anthropics/anthropic-sdk-typescript/blob/main/CHANGELOG.md#01240-2026-09-04), and the refreshed 31-tool Claude allowance lists are unchanged. ([CYPACK-1504](https://linear.app/ceedar/issue/CYPACK-1504/update-anthropic-aiclaude-agent-sdk-and-anthropic-aisdk-to-the-latest), [#1467](https://github.com/cyrusagents/cyrus/pull/1467), [cyrus-hosted#1070](https://github.com/cyrusagents/cyrus-hosted/pull/1070))
