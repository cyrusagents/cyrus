...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.185` to `0.3.196` and `@anthropic-ai/sdk` from `^0.105.0` to `^0.107.0`, bringing in the latest Claude Code capabilities and bug fixes. ([SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md)) ([CYPACK-1361](https://linear.app/ceedar/issue/CYPACK-1361), [#1357](https://github.com/cyrusagents/cyrus/pull/1357))
- Refreshed Claude Code tool list: added `ReportFindings`, removed deprecated `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` tools. ([CYPACK-1361](https://linear.app/ceedar/issue/CYPACK-1361), [#1357](https://github.com/cyrusagents/cyrus/pull/1357))
