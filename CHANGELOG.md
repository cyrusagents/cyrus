...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.185` to `0.3.195` and `@anthropic-ai/sdk` from `^0.105.0` to `^0.107.0`, bringing in the latest Claude Code capabilities and bug fixes. See [SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md). ([CYPACK-1359](https://linear.app/ceedar/issue/CYPACK-1359), [#1356](https://github.com/cyrusagents/cyrus/pull/1356))
- Refreshed Claude Code tool list for SDK v0.3.195: removed deprecated `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` tools which no longer appear in the SDK init block. ([CYPACK-1359](https://linear.app/ceedar/issue/CYPACK-1359), [#1356](https://github.com/cyrusagents/cyrus/pull/1356))
