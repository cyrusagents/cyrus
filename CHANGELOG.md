...
- Refreshed Claude Code tool list: added `ReportFindings`; removed deprecated `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` tools. ([CYPACK-1364](https://linear.app/ceedar/issue/CYPACK-1364))
