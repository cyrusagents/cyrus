...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.268` to [`0.3.278`](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#03278), bringing Claude sessions to parity with Claude Code 2.1.278. The accumulated update improves resumed and forked session accounting, preserves complete queued-message history, exposes richer startup, usage, and latency metadata, and makes MCP startup behavior more controllable. Updated `@anthropic-ai/sdk` from `^0.125.0` to [`^0.127.0`](https://github.com/anthropics/anthropic-sdk-typescript/releases/tag/sdk-v0.127.0), adding compaction controls, rate-limit group metadata, and client reliability fixes. The refreshed 30-tool Claude allowance lists remove the retired `TaskOutput` tool. ([CYPACK-1534](https://linear.app/ceedar/issue/CYPACK-1534/update-anthropic-aiclaude-agent-sdk-and-anthropic-aisdk-to-the-latest), [#1499](https://github.com/cyrusagents/cyrus/pull/1499), [cyrus-hosted#1094](https://github.com/cyrusagents/cyrus-hosted/pull/1094))
