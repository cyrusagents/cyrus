...
### Added
- Open `/board` on the local Cyrus server to see active tasks and searchable live logs. The status board starts with Cyrus and shares its existing port, with no separate monitoring service required.
