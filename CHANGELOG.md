...
### Changed
- The bundled Codex CLI and SDK are now pinned to an exact version (0.137.0) instead of a caret range, so Codex protocol behavior can't change underneath a Cyrus release.
