...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` to `0.3.179` (latest) and `@anthropic-ai/sdk` to `^0.104.2`. Refreshed the Claude Code tool list: added `DesignSync`, removed `TeamCreate` and `TeamDelete` per the [Claude Code 2.1.178 changelog](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md#21178), which says agent-team sessions now use one implicit team instead of explicit team lifecycle tools. See also the [SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md). ([CYPACK-1335](https://linear.app/ceedar/issue/CYPACK-1335), [#1331](https://github.com/cyrusagents/cyrus/pull/1331))
