...
### Fixed
- Prevent branch names and worktree paths from being interpreted as shell commands when preparing or cleaning up agent workspaces. ([#1492](https://github.com/cyrusagents/cyrus/pull/1492))
