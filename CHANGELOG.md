...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.185` to `0.3.191` and `@anthropic-ai/sdk` from `^0.105.0` to `^0.106.0`, bringing in the latest Claude Code capabilities including inline notebook diffs, per-model weekly rate-limit info, improved background agent permission forwarding, and `rewind_conversation` support. ([CYPACK-1354](https://linear.app/ceedar/issue/CYPACK-1354), [#1349](https://github.com/cyrusagents/cyrus/pull/1349))
- Refreshed Claude Code tool list: removed `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` which are no longer emitted in the SDK init block. ([CYPACK-1354](https://linear.app/ceedar/issue/CYPACK-1354), [#1349](https://github.com/cyrusagents/cyrus/pull/1349))
