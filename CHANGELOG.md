...
- Refreshed Claude Code tool list for SDK v0.3.195: removed deprecated `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` tools which no longer appear in the SDK init block. ([CYPACK-1359](https://linear.app/ceedar/issue/CYPACK-1359))
