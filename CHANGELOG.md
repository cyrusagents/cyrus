...
- Refreshed Claude Code tool list: removed deprecated `AskUserQuestion`, `EnterPlanMode`, and `ExitPlanMode` tools (no longer emitted by Claude Code in this SDK version). Tool count: 32 → 29. ([CYPACK-1355](https://linear.app/ceedar/issue/CYPACK-1355))
