...
import { createFetchFailureModesClient } from "../../../src/tools/miko-tools/failure-modes-http-client.js";
...
describe("createFetchFailureModesClient", () => {
	it("sends Bearer token + JSON body to /api/failure-modes", async () => {
		...
		expect(url).toBe("https://control-plane.example.com/api/failure-modes");
