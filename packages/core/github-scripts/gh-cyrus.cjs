 ...
 *
 * An explicit CYRUS_GITHUB_USER_ID selects only that personal entry before
 * any org or host fallback. Missing/revoked personal credentials refuse.
 *
