 ...
 *
 * Example: cwd = /Users/alice/.miko/worktrees/ENG-1/repo
 *          additionalAllowedPaths = [/Users/alice/.miko/ENG-1/attachments]
 * Allows:  ~/.miko/worktrees/ENG-1/repo  (cwd)
 *          ~/.miko/ENG-1/attachments      (additional allowed path)
