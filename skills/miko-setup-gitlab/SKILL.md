---
name: miko-setup-gitlab
description: Configure GitLab authentication for Miko — glab CLI login and git config for creating merge requests.
---
...
Configures GitLab CLI and git so Miko can create branches, commits, and merge requests.
