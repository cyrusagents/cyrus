...
- **`"readOnly"`**: Only tools that read/view content (13 tools)
   - `Read`, `WebFetch`, `WebSearch`, `TaskCreate`, `TaskUpdate`, `TaskGet`, `TaskList`, `Task`, `ListAgents`, `Skill`, `Monitor`, `LSP`, `ToolSearch`
